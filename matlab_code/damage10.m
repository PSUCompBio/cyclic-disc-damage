...
function [Dmech, Dtot, Da, d_out] = damage10(d_in,matrix, p, n, b, r)
% matrix=cycle data
% p = number of days
...
Nf_mod_p=d_in(2);
alpha_mod_p=d_in(3);
p_i=d_in(4); %previous i, i.e., number of days passed already
